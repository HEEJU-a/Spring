...
//        final HttpEntity<String> entity = new HttpEntity<String>(HEADERS);
        ...
        //String urlWithParam = url + "?LAWD_CD=" + param.getExternal_cd() + "&DEAL_YMD=" + deal_ym + "&serviceKey=" + decodeServiceKey;
...
//        for(ApartmentInfoEntity a : list){
//            System.out.println(a);
//        }
        mapper.insApartmentInfoArr(param2);
    }

    public List<ApartmentInfoDTO> result(SearchDTO param){
        param.setLocation_cd(mapper.selLocationCodeList(param).get(0).getCd());
        return mapper.selApartmentList(param);
    }
}
